...
window.googleAnalytics = _honeycombAnalytics2.default; // Set globally so can use it in different modules, like video.
...
window.toggle = _honeycomb29.default.toggle;
    ...
    if (toggles.length > 0) {
        ...
        try {
            for (var _iterator = toggles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var _toggle = _step.value;


                // Hide the toggle items.
                var items = _toggle.querySelectorAll(hook + "-item");
                ...
                var as = _toggle.querySelectorAll(hook + "-nav a");
